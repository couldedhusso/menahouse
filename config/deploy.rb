...
role :web, 'ec2-52-58-234-223.eu-central-1.compute.amazonaws.com' # Your HTTP server, Apache/etc
role :app, 'ec2-52-58-234-223.eu-central-1.compute.amazonaws.com' # This may be the same as your `Web` server
