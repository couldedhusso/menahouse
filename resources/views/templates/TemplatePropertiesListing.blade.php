...
<body class="page-sub-page page-listing-lines page-search-results" id="page-top" ng-app="mainApp" ng-controller="mainController">
<!-- Wrapper -->
<div class="wrapper">
    <!-- Navigation -->
            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    <div class="navbar-brand nav" id="brand">
                        <a href="index.html"> <img src="assets/img/logo.png" alt="Менахаус" title="Менахаус"></a>
                    </div>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="has-child"><a href="#" title="Основное личное меню пользователя"><i class="fa fa-user fa-fw"></i>&nbsp;Личный кабинет</a>
                            <ul class="child-navigation">
                              <li><a href="mailbox.html" title="Проверить новые сообщения, вам должно повезти" class="list-group-item"><i class="fa fa-envelope-o"></i>&nbsp; Сообщения мне &nbsp;<span class="label label-danger pull-right">14</span></a></li> <!-- CZ кол-во сообщений выводится из базы -->
								                <li><a href="my-properties.html" title="Проверить и добавить новое объявление"><i class="fa fa-th-list"></i>&nbsp; Мои объявления</a></li>
								                <li><a href="profile.html" title="Настройки пользователя и сайта"><i class="fa fa-cogs"></i>&nbsp; Настройки</a>
                                <li><a href="index.html" title="Обязательно зайдите завтра проверить новые сообщения!"><i class="fa fa-sign-out"></i>&nbsp;Выход</a></li>
                            </ul>
                        </li>
                        <li>&nbsp;&nbsp;&nbsp;</li>
                        <a href="submit.html" class="btn btn-white-green" title="Разместить объявление своей квартиры бесплатно!"><i class="fa fa-plus"></i>&nbsp; Разместить объявление</a>
                    </ul>
                </nav><!-- /.navbar collapse-->
            </header><!-- /.navbar -->
        </div><!-- /.container -->
                ...
                <div class="col-md-9 col-sm-9">
                    <section id="results">
                        ...
                        <section id="properties" class="display-lines">
                          <div class="property">
                            <span class="actions pull-right">
                              ...
                              <div class="info">
                                  ...
                                  <a href="property-detail.html" class="btn btn-white-grey-3 btn-m-3" title="Открыть объявление, узнать полную информацию и написать владельцу">
                                    <span>&nbsp; Подробнее &nbsp;</span>
                          ...
                          <div class="property" style="border: 1px solid #d2d2d2"> <!-- Border добавлен для  редактирования и тестирования -->
                            <span class="actions pull-right">
                                <!--<a href="#" class="fa fa-print"></a>-->
                                <a href="#" class="bookmark" data-bookmark-state="empty"><span class="title-add">В избранное</span><span class="title-added">Добавлено</span></a>
                            </span>
...
<script type="text/javascript" src="js/src/menahouseInit.js"></script>

{{-- <script>angular.module("mainApp", ["ui-rangeSlider"]).controller("mainController", function ($scope) {
